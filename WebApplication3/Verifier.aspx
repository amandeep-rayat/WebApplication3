<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="Verifier.aspx.cs" Inherits="WebApplication3.WebForm1" %>
    ...
    <script>
        ...
        function applyFiltersAndSearch() {
            ...
            rows.forEach(row => {
                ...
                constmatchesDegree = degreeFilters.length === 0 || degreeFilters.some(filter => applicantId.includes(filter.toLowerCase()));
                constmatchesStatus = statusFilters.length === 0 || statusFilters.some(filter => status.includes(filter.toLowerCase()));
                constmatchesSearch = searchQuery === "" || applicantId.includes(searchQuery) || status.includes(searchQuery);
