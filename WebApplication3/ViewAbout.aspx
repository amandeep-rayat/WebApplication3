<%@ Page Title="" Language="C#" MasterPageFile="~/Site1.Master" AutoEventWireup="true" CodeBehind="ViewAbout.aspx.cs" Inherits="WebApplication3.ViewAbout" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <div class="d-flex flex-column justify-content-center align-content-center flex-lg-wrap">
        ...
        <section class="" style="max-width: 900px" aria-labelledby="hostingTitle">
            <h4>About Us:</h4>
            <p>The Scholarship Process is an intensive process that involves multiple steps throughout the process. An applicant fills in the form first, then the form data is stored, and the eligibility of applicants is verified.
               The eligible applications are stored, and further processes are initiated which include verification of documents, and approval from authorities, followed by many steps of updating and notifying both authorities and applicants about the status of the application process.
                This website provides a user-friendly interface to the admin and verifier</p>
        </section>
    </div>
